...
},{"orientationchangeend":1,"sister":4}],4:[function(require,module,exports){
(function (global){
/**
...
var incubator = require('./incubator');
...
module.exports = {
    assets: {
        atlas: [
            ...
            {
                name: 'drill',
                png : 'assets/images/drill.png',
                json: 'assets/images/drill.json'
            },
            {
                name: 'heart',
                png : 'assets/sprites/heart.png',
                json: 'assets/sprites/heart.json'
            },
            {
                name: 'shield',
                png : 'assets/sprites/shield.png',
                json: 'assets/sprites/shield.json'
            },
            {
                name: 'weap_dmg',
                png : 'assets/sprites/weap_dmg.png',
                json: 'assets/sprites/weap_dmg.json'
            },
            {
                name: 'weap_spd',
                png : 'assets/sprites/weap_spd.png',
                json: 'assets/sprites/weap_spd.json'
            },
            {
                name: 'speed',
                png : 'assets/sprites/speed.png',
                json: 'assets/sprites/speed.json'
            },
            {
                name: 'super_speed',
                png : 'assets/sprites/super_speed.png',
                json: 'assets/sprites/super_speed.json'
            },
            {
            ...
            {
                name: 'left_weap',
                png: 'assets/images/left_weap.png',
                json: 'assets/images/left_weap.json'
            },
            {

                name: 'middle_weap',
                png: 'assets/images/middle_weap.png',
                json: 'assets/images/middle_weap.json'
            },
            {

                name: 'right_weap',
                png: 'assets/images/right_weap.png',
                json: 'assets/images/right_weap.json'
            },
            {
            ...
            },
            {
                ...
                name: 'super_speed',
                png: 'assets/images/super_speed.png',
                json: 'assets/images/super_speed.json'
            },
            {
                name: 'title',
        ...
        images: [
            ...
            {
                name: 'bgIncubator',
                path: 'assets/images/incubator_bg.png'
            },
            {
                name: 'talents_bg',
                path: 'assets/images/talents_bg.png'},
            {
                name: 'live_box',
...
},{"./incubator":6,"./powerups":7}],6:[function(require,module,exports){
module.exports = {
    ...
    // Lvl2
      ...
      btn: {
        name: 'heart',
        requiredFixedPowerUp: ['shieldLvl1'],
        idleFrame: 1,
        activeFrame: 0
      },
    	x: 558,
...

      {
          ...
          btn: {
              name: 'weap_spd',
              requiredFixedPowerUp: ['damageLvl1'],
              idleFrame: 1,
              activeFrame: 0
          }
          //hud:{
...

      {
          ...
          btn: {
              name: 'middle_weap',
              requiredFixedPowerUp: ['speedLvl1'],
              idleFrame: 1,
              activeFrame: 0
          }
          //hud:{
    ...
    // Lvl3
      {
          ...
          btn: {
              name: 'shield',
              requiredFixedPowerUp: ['heartLvl2', 'undefinedLvl2'],
              idleFrame: 1,
              activeFrame: 0
          },
          x: 620,
      ...
      },
    {
      ...
      btn: {
        name: 'heart',
        requiredFixedPowerUp: ['firerateLvl2', 'undefinedLvl2'],
        idleFrame: 1,
        activeFrame: 0
      },
    	x: 735,
    ...
    },
      {
          ...
          btn: {
              name: 'left_weap',
              requiredFixedPowerUp: ['healthLvl2'],
              idleFrame: 1,
              activeFrame: 0
          },
          x: 498,
      ...
      },
      {
          ...
          btn: {
              name: 'right_weap',
              requiredFixedPowerUp: ['firerateLvl2'],
              idleFrame: 1,
              activeFrame: 0
          },
          x: 852,
    ...
    // Lvl 4
    {
        ...
        btn: {
            name: 'heart',
            requiredFixedPowerUp: ['undefinedLvl3Left', 'shieldLvl3'],
            idleFrame: 1,
            activeFrame: 0
        },
        x: 558,
    ...
    },
      {
          ...
          btn: {
              name: 'super_speed',
              requiredFixedPowerUp: ['shieldLvl3', 'healthLvl3'],
              idleFrame: 1,
              activeFrame: 0
          },
          x: 674,
      ...
      },
      {
          ...
          btn: {
              name: 'weap_dmg',
              requiredFixedPowerUp: ['healthLvl3', 'undefinedLvl3'],
              idleFrame: 1,
              activeFrame: 0
          },
          x: 795,
...
var BootState = require('./states/boot'),
    ...
    Incubator = require('./states/incubator'),
...
window.onload = function () {
    ...
    game.state.add('incubator', Incubator);
...
},{"../game/config/game":5,"./states/boot":42,"./states/credits":43,"./states/incubator":44,"./states/menu":45,"./states/play":46,"./states/powerup":47,"./states/preload":48}],9:[function(require,module,exports){
...
},{"../modules/Dispatcher":10,"../modules/game-data":20,"./Utils":13,"./weaponManager/bullets/bigBall":31,"./weaponManager/bullets/electro":32,"./weaponManager/bullets/smallBall":33,"./weaponManager/weapons/ElectroGun.js":35,"./weaponManager/weapons/MachineGun.js":36,"./weaponManager/weapons/ShotGun.js":37,"./weaponManager/weapons/SuperSpryGun.js":38,"./weaponManager/weapons/ThreeGun":39,"./weaponManager/weapons/pistol.js":40,"./weaponManager/weapons/revolver.js":41}],10:[function(require,module,exports){
'use strict';
...
},{"./Dispatcher":10,"./StoredData":12}],12:[function(require,module,exports){
'use strict';
...
StoredData.prototype = {
  ...
  saveLocalStorage: function saveLocalStorage(){
    var colKeys = Object.keys(gameData.fixedPowerUps);
    for (var i = 0, cL = colKeys.length; i < cL; i++){
      var prop = colKeys[i];
      localStorage.setItem(prop, gameData.fixedPowerUps[prop]);
    }
  },
  getLocalStorage: function getLocalStorage(){
    for (var i = 0, lsL = localStorage.length; i < lsL; i++){
      var key = localStorage.key(i);
      gameData.fixedPowerUps[key] = localStorage.getItem(key);
    }
  }
};
...
},{"./game-data":20}],13:[function(require,module,exports){
'use strict';
...
},{"../../modules/Dispatcher":10,"../../modules/game-data":20}],16:[function(require,module,exports){
'use strict';
...
},{"./EnemyBullet":17}],17:[function(require,module,exports){
var dispatcher = require('../Dispatcher');
...
},{"../Dispatcher":10}],18:[function(require,module,exports){
var dispatcher = require('../Dispatcher');
var gameData = require('../game-data');
...
},{"../Dispatcher":10,"../game-data":20}],19:[function(require,module,exports){
module.exports = [
    // Events
    "setTrapCollision",
    "setRewardCollision",
...
var EnemiesGenerator = function EnemiesGenerator(game) {
	...
	this.generate = function generate(map, level, hero) {
		...
		var levelStep = Math.ceil(level / game.config.challengeSystem.levelStep);
			minEnemies = game.config.challengeSystem.initialEnemies + game.config.challengeSystem.enemiesIncrement * (levelStep - 1),
			maxEnemies = game.config.challengeSystem.initialEnemies + game.config.challengeSystem.enemiesIncrement * levelStep,
		...
		// 	}		
		// }
		console.log('Enemigos generados', levelStep, totalEnemies);
...
},{"../Utils":13,"../enemies/enemy":18,"../game-data":20}],22:[function(require,module,exports){
...
module.exports = Hud;
},{"../game-data":20}],24:[function(require,module,exports){
'use strict';
...
},{"../game-data":20}],25:[function(require,module,exports){
'use strict';
...
var Powerup = function Powerup(params) {
	...
	this.configPowerUp = params.configPowerup;

	Phaser.Group.call(this, params.game, params.game.world, this.configPowerup);

	var self = this;
	
	this.x = this.configPowerUp.x;
	this.y = this.configPowerUp.y;

	var initButton = function initButton(){
		self.btn = self.game.add.button(0, 0, self.game.config.powerups.spriteNameBtn, params.callback, self, 1, 0, 0, 0, self);
	};

	var initNum = function initNum(){
        var style = { font: "bold 32px Arial", fill: "#fff", boundsAlignH: "center", boundsAlignV: "middle" };
        self.num = self.game.add.text(58, -50, gameData.powerUps[self.configPowerUp.id].toString(), style, self);
	};
...
},{"../game-data":20}],27:[function(require,module,exports){
var dispatcher = require('../Dispatcher');
var gameData = require('../game-data');
var utils = require('../Utils');
'use strict';
...
},{"../Dispatcher":10,"../Utils":13,"../game-data":20}],28:[function(require,module,exports){
'use strict';
var dispatcher = require('../../modules/Dispatcher');
...
},{"../../modules/Dispatcher":10}],29:[function(require,module,exports){
...
},{"../../plugins/brim":49,"platform":2,"scream":3}],30:[function(require,module,exports){
var Dispatcher = require('../Dispatcher');
...
},{"../Dispatcher":10}],31:[function(require,module,exports){
...
},{"../Utils":13,"../game-data":20}],35:[function(require,module,exports){
...
},{"../../Utils.js":13,"../weapon.js":34}],39:[function(require,module,exports){
var Weapon = require('../weapon.js');
...
},{"../modules/assets":14}],44:[function(require,module,exports){
'use strict';
var gameData = require('../modules/game-data');
var storedData = require('../modules/StoredData');
...
Incubator.prototype = {
    create: function () {
        var self = this,
            config = this.game.config.incubator;

        this.clickPlay = function clickPlay(){
            this.game.state.start('play');
        };
        ...
        this.updateCoins = function updateCoins(coins){
            this.coins.text = gameData.currentCoins - coins;
        };

        this.bg = this.game.add.sprite(0,0, 'bgIncubator');
        this.game.camera.setPosition(0, 0);
        this.game.camera.x = 0;

        this.coinsImg = this.game.add.sprite(400, 55, 'coinsHud');

        this.coins = this.game.add.bitmapText(450, 75, 'big', "" + gameData.currentCoins);
        this.coins.anchor.setTo(0, 0.5);

        this.bgTalents = this.game.add.sprite(350, 150, 'talents_bg');

        this.drill = this.game.add.sprite(70, 220, 'drill', 0);
        this.drillAnimation = this.drill.animations.add('drillA', [0, 1, 2, 3], 6, true);
        this.drillAnimation.play('drillA');

        this.drillTween = this.game.add.tween(this.drill).to( { y: 200 }, 2000, "Linear", true, 0, -1);
        this.drillTween.yoyo(true, 0);
        this.drillTween.start();

        this.playButtonIncubator = this.game.add.button(675, 650, 'playBtn', this.clickPlay, this, 'play1', 'play2', 'play2', 'play2');
        this.playButtonIncubator.anchor.setTo(0.5, 0.5);
        this.playButtonIncubator.inputEnabled = true;

        this.menuButtonIncubator = this.game.add.button(305, 650, 'menuButtonGameOver', this.clickMenuButton, this, 'gameover_buttons0005', 'gameover_buttons0004', 'gameover_buttons0004', 'gameover_buttons0004');
        this.menuButtonIncubator.anchor.setTo(0.5, 0.5);
        this.menuButtonIncubator.inputEnabled = true;


        this.powerupTypes = config.list;

        var callbackBtns = function callbackBtns(id){
            //gameData.fixedPowerUps[id] += this.config.incremental;
            // TODO Refactor
            var coins = 0;
            console.log(id);
            //if (id.match('Lvl1')){
            //    coins = 500;
            //} else if(id.match('Lvl2')){
            //    coins = 1000;
            //} else if(id.match('Lvl3')){
            //    coins = 2500;
            //} else {
            //    coins = 5000;
            //}
       ...
       for (var i = 0, len = this.powerupTypes.length; i < len; i++) {
           var callbackFn = (function(id){ callbackBtns(id);})(config.list[i].id);
           var button = this.game.add.button(config.list[i].x, config.list[i].y, config.list[i].btn.name, self.callbackFn, this, config.list[i].btn.idleFrame, config.list[i].btn.activeFrame, config.list[i].btn.activeFrame, config.list[i].btn.activeFrame);
           button.anchor.set(0.5);
           button.inputEnabled = true;

           var itemLocalStorage = localStorage.getItem(config.list[i].id);
           if (itemLocalStorage){
               button.frame = 1;
               button.inputnabled = false;
           }

           arrButtons.push({ id: config.list[i].id, active: itemLocalStorage, button: button, dependencies: config.list[i].btn.requiredFixedPowerUp});
       }

        // Search buttons dependency
        for ( var j = 0, bL = arrButtons.length; j < bL; j++) {
            var tmpButton = arrButtons[j];
            if (!tmpButton.active){
                for(var k= 0; k < tmpButton.length; k++){
                    if (localStorage.getItem(tmpButton.dependencies[k])){
                        tmpButton.button.inputEnabled = true;
                        tmpButton.button.frame = 0;
                        break;
                    }
                }
            }
...
},{"../modules/StoredData":12,"../modules/game-data":20,"../modules/powerups/Powerup":26}],45:[function(require,module,exports){
'use strict';
...
Menu.prototype = {
    create: function () {
        ...
        var clickCredits = function clickCredits() {
            selectClick.play();
            self.game.state.start('incubator');
...
},{"../modules/game-data":20,"../modules/viewport":29}],46:[function(require,module,exports){
'use strict';
var gameData = require('../modules/game-data');
...
},{"../modules/Character":9,"../modules/Dispatcher":10,"../modules/GameOver":11,"../modules/Utils":13,"../modules/chest/Chest":15,"../modules/enemies/EnemiesBulletsController":16,"../modules/game-data":20,"../modules/generator/EnemiesGenerator":21,"../modules/generator/MapRandomGenerator":22,"../modules/hud/hud":23,"../modules/platform/ExitPlatform":24,"../modules/platform/Platform":25,"../modules/rewards/RewardsController":27,"../modules/trap/Trap":28}],47:[function(require,module,exports){
'use strict';
var gameData = require('../modules/game-data');
var Powerup = require('../modules/powerups/Powerup');
...
Powerups.prototype = {
    create: function () {
        ...
        var callbackclickeBtn = function callbackclickeBtn(){
            gameData.powerUps[this.configPowerUp.id] += this.configPowerUp.incremental;
            this.game.state.start('play');
        };

       for (var i = 0, len = this.powerupTypes.length; i < len; i++) {
           var powerup = new Powerup({game: self.game, configPowerup: this.powerupTypes[i], callback: callbackclickeBtn});
       }
...
},{"../modules/game-data":20,"../modules/powerups/Powerup":26}],48:[function(require,module,exports){
'use strict';
...
},{"../modules/assets":14}],49:[function(require,module,exports){
(function (global){
